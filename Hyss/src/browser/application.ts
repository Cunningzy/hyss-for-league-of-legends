...
import { SupportedGame } from './controllers/registerGap';
import * as gepService from './services/gep.service';

export class Application {
  constructor(
    private readonly overlayService: OverlayService,
    private readonly gepService: gepService.GameEventsService,
    ...
    gepService.registerGames([
      ...
      SupportedGame.TeamfightTactics,
      SupportedGame.DiabloIV,
      SupportedGame.RocketLeague,
    ]);
  }
